package com.roserequiem.app.activities.quicksearch.components
...
private fun ErrorCardPreview() {
    ErrorCard(
        ...
        stacktrace = "java.lang.IllegalArgumentException: Unsupported AnimationVector type\n" +
                "                                                                                                    \tat com.roserequiem.app.util.ui.DurationBasedCustomAnimationsKt.minus(DurationBasedCustomAnimations.kt:112)\n" +
                "                                                                                                    \tat com.roserequiem.app.util.ui.DurationBasedCustomAnimationsKt.access\$minus(DurationBasedCustomAnimations.kt:1)\n" +
                "                                                                                                    \tat com.roserequiem.app.util.ui.VectorizedPixelAnimationSpec.getValueFromNanos(DurationBasedCustomAnimations.kt:57)\n" +
